...
<head>
    ...
    <script type="text/javascript" type="text/javascript" type="text/javascript" type="text/javascript"
    ...
    <link href="http://fonts.googleapis.com/css?family=Advent+Pro:100,200,300,regular,500,600,700" rel="stylesheet"
          type="text/css" data-familyname="Advent Pro" data-cssintegration=
          "font-family:Advent Pro,serif;">
    <link href="http://fonts.googleapis.com/css?family=Jaldi:regular,700" rel="stylesheet" type="text/css"
          data-familyname="Jaldi" data-cssintegration="font-family:Jaldi,serif;">
    <link
...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="background-color:#B73F5C">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#" style="color:white">STAN</a>
        </div>
    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                ...
                <li>
                    <a href="#" style="color:white" class>Statistics</a>
                </li>
                <li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <form method="post" onsubmit="checkAnswer2();return false;">
                <p class="question-option" id="option1"><input type="radio">Yes</p>

                <p class="question-option" id="option2"><input type="radio">No</p>

                <p class="question-option" id="option3"><input type="radio">Maybe</p>

                <p class="question-option" id="option4"><input type="radio">What?</p>
